		        ...
		        <div class="imagem">
				     ...
				     <div class="row arq">
				      	<div class="col-xs-12 col-md-9 arq">
				      		 Olá seja muito bem vindo ao nosso site, aqui informamos sobre as principais informações de HTML, CSS, PHP e Javascript para iniciantes em programação web.<br>
				      		 Desejamos que aproveite nossos arquivos para aprender e desenvolver suas competências web, aproveite nosso site e deixe nos uma avaliação nos comentários abaixo.
				      		 <br>
