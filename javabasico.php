		        ...
		        <div class="imagem">
				     ...
				     <div class="row arq">
				      	<div class="col-xs-12 col-md-9 arq">
				      		...
				      		<br>
				      		O JavaScript (JS) é uma linguagem de programação utilizada principalmente em páginas web. Com o JS, você pode mostrar mensagens e outras informações interessantes, fazer verificações ou mudar dinamicamente a apresentação visual das páginas, conforme o comportamento que você deseja que sua página (ou aplicação) possua. Tudo através do navegador do usuário. É possível fazer isso, até mesmo sem conexão com a internet.<br>

                            IMPORTANTE: o JavaScript mudou muito com o passar dos anos. Hoje, trata-se de uma tecnologia que pode ser utilizada tanto no cliente-side de uma aplicação, quanto no server-side.<br>
                            <br>
                            <img src="img\exemplojava.jpg">
